...
| [10 grey parrot](https://github.com/muellerberndt/cadence-examples/tree/main/10_parrot) | a physical syrinx and a cochlea; one net as a sequence-coded memory and a mirror | recalls a sound at 0.99 after a day that repeated it, 0.80 after one that did not; its imitations correlate 0.69 with the originals (an untrained brain 0.03) and sit 1.5 cochlear channels from their pitch
